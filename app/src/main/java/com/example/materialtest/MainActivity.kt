...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.backup -> Toast.makeText(this, "你点击了backup", Toast.LENGTH_SHORT).show()
            R.id.delete -> Toast.makeText(this, "你点击了delete", Toast.LENGTH_SHORT).show()
            R.id.settings -> Toast.makeText(this, "你点击了settings", Toast.LENGTH_SHORT).show()
        }
        return true
    }
